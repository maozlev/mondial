...
/** Candidates for R16 match r16Idx: rank1/rank2 of specific groups only */
function getCandidatesForR16(r16Idx: number, standings: StandingPred[]): string[] {
...
export default function BracketPage() {
  ...
  const r16Cands = (r16Idx: number) => getCandidatesForR16(r16Idx, standings);
